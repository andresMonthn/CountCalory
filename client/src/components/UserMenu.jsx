...
import { Menu, LogOut, User, Shield, FileText, Settings } from 'lucide-react';
        ...
        <PopoverContent className="w-64 p-0 mr-4" align="end">
          <div className="flex flex-col bg-slate-950 border border-slate-800 rounded-md overflow-hidden shadow-xl">
            ...
            <div className="p-2 space-y-1">
              <Button 
                variant="ghost" 
                className="w-full justify-start text-slate-400 hover:text-slate-200 hover:bg-slate-800 h-9 px-2"
